...
```
cd existing_repo
git remote add origin https://gitlab.aristanetworks.com/cicd-group/arista-naas.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.aristanetworks.com/cicd-group/arista-naas/-/settings/integrations)
